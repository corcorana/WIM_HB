function HRVparams = WIM_HB_InitHRVparams()
%
...
switch project_name   
    ...
    case 'WIM'                   % Update with your project name
        HRVparams.Fs = 500;                % Spacify sampling frequency
        HRVparams.readdata = '';           % (Optional) Specify name for data input folder
        HRVparams.writedata = 'QRS_events';          % (Optional) Specify name for data output folder
        HRVparams.datatype = 'Filtered ECG waveform';           % (Optional) Spacify Data type of input
